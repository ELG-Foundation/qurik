...
class QurikTagCompiler extends ComponentTagCompiler
{
    ...
    protected function compileOpeningTags(string $value)
    {
        ...
        return preg_replace_callback($pattern, function (array $matches) {
            ...
            return $this->componentString("qurik::$matches[1]", $attributes);
        }, $value);
    }
    ...
    protected function compileSelfClosingTags(string $value)
    {
        ...
        return preg_replace_callback($pattern, function (array $matches) {
            ...
            if (isset($attributes['slot'])) {
                ...
                return '@slot(' . $slot . ') ' . $this->componentString("qurik::$matches[1]", $attributes) . "\n@endComponentClass##END-COMPONENT-CLASS##" . ' @endslot';
            }
    ...
    {
        return preg_replace("/<\/\s*qurik[\:][\w\-\:\.]*\s*>/", ' @endComponentClass##END-COMPONENT-CLASS##', $value);
    }
}
